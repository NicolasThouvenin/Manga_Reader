DELIMITER $$
CREATE PROCEDURE createUser(IN inLogin VARCHAR(255), IN inFirstname VARCHAR(255), IN inSurname VARCHAR(255), IN inBirthDate VARCHAR(10), IN inPassword VARCHAR(255), IN inEmail VARCHAR(254), OUT lastUserId INTEGER)
